  ...
  Rectangle {
    ...
    RowLayout {
      ...
      TailscaleIcon {
        ...
        crossed: !root.tailscaleConnected && !root.tailscaleConnecting
        slashBackgroundColor: mouseArea.containsMouse ? Color.mHover : Style.capsuleColor
        litColor: mouseArea.containsMouse ? Color.mOnHover : Color.mOnSurface
        dimColor: mouseArea.containsMouse ? Color.mOnHover : Color.mOnSurface
      }
