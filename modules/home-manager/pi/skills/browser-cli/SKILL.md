---
name: browser-cli
description: Control Firefox browser from the command line. Use for web automation, scraping, reading web pages, testing, or any browser interaction tasks.
---

# Browser CLI

Requires Firefox with the browser-cli extension loaded. Install via
`nix run github:Mic92/mics-skills#browser-cli`. See the mics-skills repo
(`$HOME/git/mics-skills/browser-cli/`) for Firefox extension setup.
...
See the mics-skills repo (`$HOME/git/mics-skills/browser-cli/`) for full
installation, architecture, and API reference.
